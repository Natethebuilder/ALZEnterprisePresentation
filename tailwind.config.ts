...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        // Segoe UI is the Microsoft brand face; Inter is the cross-platform
        // fallback with near-identical metrics for macOS/Linux.
        sans: [
          '"Segoe UI Variable Text"', '"Segoe UI"', 'Inter', 'system-ui',
          '-apple-system', 'BlinkMacSystemFont', 'sans-serif',
        ],
        display: [
          '"Segoe UI Variable Display"', '"Segoe UI"', 'Inter', 'system-ui',
          '-apple-system', 'BlinkMacSystemFont', 'sans-serif',
        ],
      ...
      colors: {
        ...
        // Microsoft brand tokens
        ms: {
          blue: 'hsl(var(--ms-blue))',
          'blue-shade': 'hsl(var(--ms-blue-shade))',
          'blue-dark': 'hsl(var(--ms-blue-dark))',
          navy: 'hsl(var(--ms-navy))',
          cyan: 'hsl(var(--ms-cyan))',
          'logo-red': 'hsl(var(--ms-logo-red))',
          'logo-green': 'hsl(var(--ms-logo-green))',
          'logo-blue': 'hsl(var(--ms-logo-blue))',
          'logo-yellow': 'hsl(var(--ms-logo-yellow))',
        },
