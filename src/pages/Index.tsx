...
import { azureSlides } from '@/slides/azure';
...
export default function Index() {
  ...
  // Derive slides from azureSlides with deterministic IDs (for presenter notes persistence)
  ...
  const ActiveSlideComponent = slides[activeSlideIndex]?.component || azureSlides[0].component;
